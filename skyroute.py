...
stations_under_construction = ['King Edward', 'King George']
...
def new_route(start_point=None, end_point=None):
    ...
    if shortest_route:
        ...
        print("The shortest metro rout from {0} to {1} is:\n{2}". format(start_point,end_point,shortest_route_string))
    else:
    ...
    for start_station in start_stations:
        for end_station in end_stations:
            ...
            if stations_under_construction:
                ...
                if not possible_route: return None
...
# ~ MODIFYING THE AVAILABLE STATIONS ~ #
...
def get_active_stations():
    ...
    for station_under_construction in stations_under_construction:
        for current_station, neighboring_stations in vc_metro.items():
            ...
            else: updated_metro[current_station] = set([])
    return updated_metro


# ~ PRINTING OUT ALL LOCATIONS ~ #
def show_landmarks():
    see_landmarks = input("Would you like to see the list of landmarks again? Enter y/n:")
    if see_landmarks == "y": print(landmark_string)
